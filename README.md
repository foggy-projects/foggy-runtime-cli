...
```powershell
powershell -ExecutionPolicy Bypass -File .\install-foggy-runtime-cli.ps1 -Version 0.1.3
foggy-runtime --help
```
...
```bash
bash install-foggy-runtime-cli.sh --version 0.1.3
foggy-runtime --help
```
...
```powershell
python -m pip install foggy_runtime_cli-0.1.3-py3-none-any.whl
foggy-runtime --help
```
