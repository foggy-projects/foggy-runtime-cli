...
ANALYSIS_SKILL_RELEASE_ZIP_URL = skills_cli.ANALYSIS_SKILL_RELEASE_ZIP_URL
ANALYSIS_SKILL_ZIP_INSTALL_COMMAND = skills_cli.ANALYSIS_SKILL_ZIP_INSTALL_COMMAND
ANALYSIS_SKILL_WORKSPACE_INSTALL_COMMAND = (
    skills_cli.ANALYSIS_SKILL_WORKSPACE_INSTALL_COMMAND
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    stack_cli.register_stack_parser(subparsers)
    ...
    skills_cli.register_skills_parser(subparsers)
...
def demo_sales_drop_plan(args: argparse.Namespace) -> dict[str, Any]:
    ...
    skill_dir, candidate_skill_dirs = skills_cli.resolve_sales_drop_skill_dir(
        args.skill_dir, repo_root
    )
    demo_dir = skills_cli.sales_drop_demo_dir(skill_dir)
